 ...
 *
 * Form Request para validación de actualización de Settings.
 */
class UpdateSettingsRequest extends BaseFormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'key' => ['sometimes', 'string', 'max:255', Rule::unique('settings', 'key')->ignore($id), 'regex:/^[a-zA-Z0-9._]+$/'],
            'value' => ['sometimes'],
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            // Solo validar si se proporcionan ambos
            if ($type && $value !== null) {
                $isValid = match ($type) {
